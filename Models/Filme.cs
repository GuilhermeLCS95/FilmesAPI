...
namespace FilmesAPI.Models
{
    public class Filme
    {
        ...
        [MaxLength(50, ErrorMessage = "Tamanho do título não deve ser maior que 50 caracteres.")]
        ...
        [MaxLength(20, ErrorMessage = "Tamanho do título não deve ser maior que 50 caracteres.")]
